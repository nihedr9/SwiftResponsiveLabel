...
final class InteractiveTableViewCell: UITableViewCell {
	...
	override func awakeFromNib() {
		...
		self.expandAttributedToken.addAttributes([
			...
			NSAttributedString.Key.font : responsiveLabel.font
	...
	func configureText(_ str: String, forExpandedState isExpanded: Bool) {
		if (isExpanded) {
			...
			finalString.addAttributes([NSAttributedString.Key.font : responsiveLabel.font], range: NSRange(location: 0, length: finalString.length))
