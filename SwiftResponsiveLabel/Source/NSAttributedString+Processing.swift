...
extension NSAttributedString.Key {
    public static let RLTapResponder = NSAttributedString.Key(rawValue: "TapResponder")
	public static let RLHighlightedForegroundColor = NSAttributedString.Key(rawValue: "HighlightedForegroundColor")
	public static let RLHighlightedBackgroundColor = NSAttributedString.Key(rawValue: "HighlightedBackgroundColor")
	public static let RLBackgroundCornerRadius = NSAttributedString.Key(rawValue: "HighlightedBackgroundCornerRadius")
	public static let RLHighlightedAttributesDictionary = NSAttributedString.Key(rawValue: "HighlightedAttributes")
}
